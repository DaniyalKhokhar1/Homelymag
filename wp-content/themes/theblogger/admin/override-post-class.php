<?php
	...
	function theblogger_post_class($classes, $class, $post_id)
	{
		if (! is_admin())
		{
			...
			{
				$classes[] = esc_attr(theblogger_portfolio_page__post_class());
			}
			...
			{
				$classes[] = esc_attr(theblogger_category_link_style());
			}
		}
	...
	add_filter('post_class', 'theblogger_post_class', 10, 3);
