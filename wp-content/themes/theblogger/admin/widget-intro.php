	...
	class theblogger_Widget_Intro extends WP_Widget
	{
		public function __construct()
		{
			parent::__construct(
				...
				esc_html__('(Pixelwars) Intro', 'theblogger'),
				array(
					'description'                 => esc_html__('Intro widget.', 'theblogger'),
		...
		public function form($instance)
		{
			...
			?>
				...
				<p>
					...
					<input type="button" class="button button-browse-video" value="<?php esc_attr_e('Browse', 'theblogger'); ?>">
						...
						<div class="intro-content">
							...
							<div class="intro-text">
								...
								<?php
									...
									{
										?>
											<a class="button is-primary" <?php if ($theblogger_new_tab == 'yes') { echo 'target="_blank"'; } ?> href="<?php echo esc_url($theblogger_button_url); ?>">
												<?php
