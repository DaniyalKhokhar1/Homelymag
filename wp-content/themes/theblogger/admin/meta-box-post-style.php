			...
			<div class="admin-inside-box">
				...
				<p>
					...
					<select id="theblogger_post_style" name="theblogger_post_style">
						...
						<option <?php if ($post_style == 'is-top-content-single-full-screen with-overlay') { echo 'selected="selected"'; } ?> value="is-top-content-single-full-screen with-overlay"><?php esc_html_e('Overlay Fullscreen', 'theblogger'); ?></option>
