	...
	function theblogger_widgets_init()
	{
		...
		register_sidebar(
			array(
				...
				'description'   => esc_html__('Select this sidebar in edit screen of a page to display it with this sidebar.', 'theblogger'),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title"><span>',
				'after_title'   => '</span></h3>'
		...
		register_sidebar(
			array(
				...
				'description'   => esc_html__('Select this sidebar in edit screen of your portfolio page. Also this sidebar can be used for portfolio categories and portfolio posts when activated from Customizer > Sidebar.', 'theblogger'),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title"><span>',
				'after_title'   => '</span></h3>'
		...
		register_sidebar(
			array(
				'id'            => 'theblogger_sidebar__top_bar_left',
				'name'          => esc_html__('Top Bar Left', 'theblogger'),
		...
		register_sidebar(
			array(
				'id'            => 'theblogger_sidebar__top_bar_right',
				'name'          => esc_html__('Top Bar Right', 'theblogger'),
				'description'   => esc_html__('Add widget.', 'theblogger'),
				'before_widget' => "",
				'after_widget'  => "",
				'before_title'  => '<span style="display: none;">',
		...
		register_sidebar(
			array(
				'id'            => 'theblogger_sidebar__logo_before',
				'name'          => esc_html__('Logo Before', 'theblogger'),
				'description'   => esc_html__('Add widget.', 'theblogger'),
				'before_widget' => "",
				'after_widget'  => "",
				'before_title'  => '<span style="display: none;">',
		...
		register_sidebar(
			array(
				'id'            => 'theblogger_sidebar__logo_after',
				'name'          => esc_html__('Logo After', 'theblogger'),
				'description'   => esc_html__('Add widget.', 'theblogger'),
				'before_widget' => "",
				'after_widget'  => "",
				'before_title'  => '<span style="display: none;">',
