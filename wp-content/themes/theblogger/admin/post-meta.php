<?php
	...
	function theblogger_meta_views_count()
	{
			...
			if (shortcode_exists('tptn_views'))
			{
				?>
					<span class="entry-view">
						<?php
							echo do_shortcode('[tptn_views]') . ' ' . esc_html__('Views', 'theblogger');
						?>
					</span> <!-- .entry-view -->
				<?php
			}
	...
	{
		theblogger_core_share_links_meta();
	}
	
	function theblogger_meta_edit()
	{
		edit_post_link(
			esc_html__('Edit', 'theblogger'),
	...
	function theblogger_meta($meta_wrap_position)
	{
		...
		{
			$meta_position = array(
				get_theme_mod('theblogger_setting_meta_post_cat', 'below_title'),
				...
				get_theme_mod('theblogger_setting_meta_post_views_count', 'below_title'),
		...
		{
			$meta_position = array(
				get_theme_mod('theblogger_setting_meta_blog_cat', 'below_title'),
				...
				get_theme_mod('theblogger_setting_meta_blog_views_count', 'below_title'),
