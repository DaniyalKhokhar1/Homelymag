<?php
	...
	function theblogger_theme_fonts()
	{
		...
		$customizer_fonts = array(
			...
			get_theme_mod('theblogger_setting_font_buttons'),
			get_theme_mod('theblogger_setting_font_tagline'),
			get_theme_mod('theblogger_setting_font_top_bar'),
			get_theme_mod('theblogger_setting_font_icon_box_title')
		);
...
/* ============================================================================================================================================= */
	...
	function theblogger_enqueue_scripts__theme_styles()
	{
		...
		if (function_exists('is_plugin_active'))
		{
			...
			{
				wp_enqueue_style('theblogger-learn-press', $theme_directory_url . '/css/learnpress.css');
			}
		}
		
		wp_enqueue_style('theblogger-tutor', $theme_directory_url . '/css/tutor.css', array('tutor-frontend'));
	}
...
/* ============================================================================================================================================= */
	...
	add_action('elementor/editor/before_enqueue_scripts', 'theblogger_enqueue_admin');
