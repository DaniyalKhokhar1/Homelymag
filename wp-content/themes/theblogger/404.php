					...
					<div class="hentry-wrap">
						...
						<div class="entry-content">
							<div class="http-alert">
								...
								<p>
									<?php esc_html_e('The page you are looking for was not found!', 'theblogger'); ?>
								</p>
								<p>
									<a class="button big" href="<?php echo esc_url(home_url('/')); ?>"><i class="pw-icon-home"></i><?php esc_html_e('Return To Homepage', 'theblogger'); ?></a>
								</p>
							</div> <!-- .http-alert -->
						</div> <!-- .entry-content -->
					</div> <!-- .hentry-wrap -->
